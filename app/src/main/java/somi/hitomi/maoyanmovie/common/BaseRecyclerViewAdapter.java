...
import somi.hitomi.maoyanmovie.animation.AlphaInAnimation;
import somi.hitomi.maoyanmovie.animation.CustomAnimation;
import somi.hitomi.maoyanmovie.animation.ScaleInAnimation;
import somi.hitomi.maoyanmovie.animation.SlideInBottomAnimation;
import somi.hitomi.maoyanmovie.animation.SlideInLeftAnimation;
import somi.hitomi.maoyanmovie.animation.SlideInRightAnimation;
...
public abstract class BaseRecyclerViewAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    //    protected static final int UPDATE_VIEW = 0x00000666;
    ...
    /**
     * call the method will not enable the loadMore function and the params pageSize is invalid
     * more information see{@link  public void openLoadMore(int pageSize, boolean enable),@link  public void setOnLoadMoreListener(RequestLoadMoreListener requestLoadMoreListener)} method
     *
     * @param pageSize
     ...
     *
     * @param animationType One of {@link #ALPHA_IN}, {@link #SCALE_IN}, {@link #SLIDE_IN_BOTTOM}, {@link #SLIDE_IN_LEFT}, {@link #SLIDEIN_RIGHT}.
     */
    ...
    @IntDef({ALPHA_IN, SCALE_IN, SLIDE_IN_BOTTOM, SLIDE_IN_LEFT, SLIDEIN_RIGHT, SLIDEIN_CUSTOM})
    ...
    public class OnItemChildClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (mChildClickListener != null)
                mChildClickListener.onItemChildClick(BaseRecyclerViewAdapter.this, v, position - getHeaderViewsCount());
        }
    }
