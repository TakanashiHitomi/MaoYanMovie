...
//        return false;
    ...
    private boolean isFullScrean() {
        ...
        return !isBottom || isChildScrollToBottomFull(true);
    }
    ...
    private boolean isTopOverFarm() {
        if (type == Type.OVERLAP) {
            ...
            return type == Type.FOLLOW && -getScrollY() > HEADER_LIMIT_HEIGHT;
    }
    ...
    private boolean isBottomOverFarm() {
        if (type == Type.OVERLAP) {
            ...
            return type == Type.FOLLOW && getScrollY() > FOOTER_LIMIT_HEIGHT;
    }
    ...
    private boolean isTop() {
        if (type == Type.OVERLAP) {
            ...
            return type == Type.FOLLOW && getScrollY() < 0;
    }
    ...
    private boolean isFlow() {
        if (type == Type.OVERLAP) {
            ...
            return type == Type.FOLLOW && getScrollY() > -30 && getScrollY() < 30;
    }
