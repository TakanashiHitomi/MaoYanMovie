...
public class HotMovieBannerBean {

    private List<DataBean> data;

    public static HotMovieBannerBean objectFromData(String str) {

        return new Gson().fromJson(str, HotMovieBannerBean.class);
    }

    public static HotMovieBannerBean objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), HotMovieBannerBean.class);
    ...
    public static List<HotMovieBannerBean> arrayHotMovieBannerFromData(String str) {

        Type listType = new TypeToken<ArrayList<HotMovieBannerBean>>() {
        }.getType();

        return new Gson().fromJson(str, listType);
    }

    public static List<HotMovieBannerBean> arrayHotMovieBannerFromData(String str, String key) {
    ...
    public static class DataBean {
        ...
        public static class ChannelListMapBean {
            public static ChannelListMapBean objectFromData(String str) {

                return new Gson().fromJson(str, ChannelListMapBean.class);
            }

            public static ChannelListMapBean objectFromData(String str, String key) {

                try {
                    JSONObject jsonObject = new JSONObject(str);

                    return new Gson().fromJson(jsonObject.getString(str), ChannelListMapBean.class);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            ...
            public static List<ChannelListMapBean> arrayChannelListMapBeanFromData(String str) {

                Type listType = new TypeToken<ArrayList<ChannelListMapBean>>() {
                }.getType();

                return new Gson().fromJson(str, listType);
            }

            public static List<ChannelListMapBean> arrayChannelListMapBeanFromData(String str, String key) {
